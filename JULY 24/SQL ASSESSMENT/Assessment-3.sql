...
(2, 'lilly', 'cat', 'persian', 3, 'rahul'),
(3, 'rocky', 'dog', 'bulldog', 6, 'sneha'),
(4, 'jam', 'cat', 'siamese', 2, 'john'),
(5, 'coco', 'parrot', 'macaw', 4, 'divya'),
(6, 'jimmy', 'dog', 'labrador', 8, 'karan');

insert into visits values
(1, 1, '2024-01-15', 'regular checkup', 500.00),
(2, 2, '2024-02-10', 'fever', 750.00),
(3, 3, '2024-03-01', 'vaccination', 1200.00),
(4, 4, '2024-03-10', 'injury', 1800.00),
(5, 5, '2024-04-05', 'beak trimming', 300.00),
(6, 6, '2024-05-20', 'dental cleaning', 950.00),
(7, 1, '2024-06-10', 'ear infection', 600.00);
